...
const ProductList = () => {
  ...
  <div className="px-5 py-24 mx-auto">
    <div className="flex flex-col w-full mb-20">
      <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">All Futures, Options, OTC Products & Physicals</h1>
      <p className="text-left leading-relaxed text-base">Banh mi cornhole echo park skateboard authentic crucifix neutra tilde lyft biodiesel artisan direct trade mumblecore 3 wolf moon twee</p>
    </div>
      ...
      <table className="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th className="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Group</th>
            <th className="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Exchange</th>
            <th className="w-10 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br" >Expiry</th>
          </tr>
        </thead>
        <tbody>
          <tr>
    ...
    <div className="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
      <Link to="/" className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
